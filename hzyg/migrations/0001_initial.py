    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realSaleStockUnit', models.DecimalField(decimal_places=2, max_digits=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saleUnit', models.CharField(max_length=40)),
                ('amount', models.DecimalField(decimal_places=5, max_digits=22, verbose_name='数量')),
                ('orderAmount', models.DecimalField(decimal_places=5, max_digits=22)),
                ('stockUnit', models.CharField(max_length=40)),
                ('realSaleStockUnit', models.DecimalField(decimal_places=2, max_digits=20)),
            ],
            options={
